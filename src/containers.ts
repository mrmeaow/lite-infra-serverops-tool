export const get_choice_list = <T extends Record<string, unknown>>(): T =>
  ({
    ...
    minio: {
      ...
      ports: "9010, 9011 (UI)",
      isDefault: false,
      description: "S3-Compatible Storage for local/dev or testing",
    },
    mailpit: {
      name: "mailpit",
      displayName: "Mailpit",
      ...
      ports: "(UI) 8025, 1025",
      isDefault: false,
      description: "Email Testing Server for local/dev",
    },
  }) as unknown as T;
...
export const get_configs = (vol_dir: string) => ({
  ...
  postgres: [
    ...
    "-v",
    `${vol_dir}/postgresql/data:/var/lib/postgresql/data`,
    "postgres:16",
    "-c",
    "wal_level=logical",
  ],
